...
var computeScaleFactor = function(sourceTimeA, destinationTimeA, sourceTimeB, destinationTimeB) {
    ...
    sourceTimeB = sourceTimeB ? srtTimeToSeconds(sourceTimeB) : null;
    destinationTimeB = destinationTimeB ? srtTimeToSeconds(destinationTimeB) : null;
    ...
    {
        slope = 0;
        if(isNaN(sourceTimeA) || isNaN(destinationTimeA)) {
            offset = 0;
        }
        else {
